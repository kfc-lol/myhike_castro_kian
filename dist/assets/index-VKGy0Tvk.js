...
`+n.stack),t}class lg extends Tl{constructor(t,e,s,r){super(t,e,s,r),this.type="firestore",this._queue=new ja,this._persistenceKey=r?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new ja(t),this._firestoreClient=void 0,await t}}}function hg(n,t){const e=typeof n=="object"?n:$c(),s=typeof n=="string"?n:vr,r=Dr(e,"firestore").getImmediate({identifier:s});if(!r._initialized){const a=au("firestore");a&&cg(r,...a)}return r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
